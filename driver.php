...
class HUGnetDriver extends HUGnetClass
{
    ...
    * @param bool  $force   Force the update even if the serial number and hardware
    *                       part number don't match
    *
    * @return bool
    */
    ...
    */
    function getDevice($id, $type="KEY")
    {
        ...
        if (is_array($devInfo)) {
            ...
            $query .= " where DeviceKey='".$id."' ORDER BY StartDate DESC LIMIT 0,1";
    ...
    *
    * @param array $packets Infomation about the device to use plus a configuration
    *                       packet
    *
    ...
    */
    function interpConfig ($packets)
    {
        ...
        if (empty($Info)) {
            $Info = self::getDevice($packet["DeviceID"], "ID");
        }
    ...
    */
    ...
    {
        $HWPart = $Info["HWPartNum"];
        $FWPart = $Info["FWPartNum"];
        $FWVer  = $Info["FWVersion"];
    ...
    *                        modified.
    * @param array &$devInfo The devInfo array to modify.  This array gets directly
    *                        modified.
    ...
    *                      actual object to register
    * @param string $name  The name of the sensor class if the above is an
    *                      object.  The default is the class name.
    *
