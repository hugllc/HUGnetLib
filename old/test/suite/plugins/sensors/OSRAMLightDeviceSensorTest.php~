...
/** Get our classes */
require_once CODE_BASE.'plugins/sensors/OSRAMLightDeviceSensor.php';
 ...
 */
class OSRAMLightDeviceSensorTest extends DeviceSensorPluginTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new OSRAMLightDeviceSensor(
            array(
            ),
            $this->d
        );
