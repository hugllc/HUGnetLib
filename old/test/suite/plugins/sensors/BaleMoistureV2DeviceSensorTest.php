...
/** Get our classes */
require_once CODE_BASE.'plugins/sensors/BaleMoistureV2DeviceSensor.php';
 ...
 */
class BaleMoistureV2DeviceSensorTest extends DeviceSensorPluginTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new BaleMoistureV2DeviceSensor(
            array(
            ),
            $this->d
        );
    ...
    */
    ...
    {
        return array(
            array("BaleMoistureV2DeviceSensor"),
        );
    }
    /**
    ...
    */
    public function testGetReading($preload, $A, $deltaT, $expect)
    {
        ...
        $o = new BaleMoistureV2DeviceSensor($preload, $this->d);
