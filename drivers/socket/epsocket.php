...
if (!class_exists("epsocket")) {
    ...
    */
    class EpSocket extends SocketBase
    {
        ...
        /** @var the TCP server to use */
        protected $server = "127.0.0.1";
        /** @var int The TCP Port to use */
        ...
        */
        function write($packet, $GetReply = true)
        {
            ...
            if ($this->verbose) {
                print "Wrote: ".$return." chars (".$pktData.")";
        ...
        * connected already then use epsocket::Connect().
        *
        ...
        */
        private function _connectOpenSocket()
        {
            ...
            if ($this->socket !== false) {
                ...
                if ($this->verbose) {
                    print "Opened the Socket ".$this->socket." to ";
                    print $this->Server.":".$this->Port."\n";
                }
                return true;
            }
            if ($this->verbose) {
                print "Connection to ".$this->Server." Failed.";
                print " Error ".$this->Errno.": ".$this->Error."\n";
            }
            return false;
        }
        ...
        */
        function __construct($config = array())
        {
            ...
            if ($this->verbose) {
                print "Creating Class ".get_class($this)."\r\n";
            }
            $this->Connect();
            if ($this->verbose) {
                print "Done\r\n";
