 ...
 */
class Dwyer616PressureDeviceSensor extends CurrentDeviceSensorBase
{
    /** @var This is to register the class */
    public static $registerPlugin = array(
        "Name" => "Dwyer 616 Pressure Sensor",
        "Type" => "sensor",
        "Class" => "Dwyer616PressureDeviceSensor",
        "Flags" => array("50:dwyer616"),
    );
    ...
    protected $typeValues = array("dwyer616");
    /**
    ...
    */
    protected $fixed = array(
        ...
        // Null    nothing
        "extraValues" => array(5, 5, 7, 7, 10, 5),
        "extraDefault" => array(4, 20, -1.5, 1.5, 249, 1),
        "maxDecimals" => 4,
    );
    /**
