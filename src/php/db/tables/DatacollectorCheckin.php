 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class DataCollectorCheckin extends \HUGnet\db\Table
    implements \HUGnet\interfaces\DBTable
{
    /** @var string This is the table we should use */
    public $sqlTable = "datacollectorcheckin";
    ...
    *
    * @param string $uuid The uuid that is checking in
    *
    * @return null
    */
