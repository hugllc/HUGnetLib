 ...
 */
class RawBatCapacity extends \HUGnet\devices\inputTable\Driver
    implements \HUGnet\devices\inputTable\DriverInterface
{
    ...
    */
    protected $params = array(
        "longName" => "Battery Capacity",
        "shortName" => "BatCapacity",
    ...
    */
    ...
    {
        return round($this->signedInt($A, $this->get("inputSize")) / 1000, $this->get("maxDecimals"));
    }
    /**
