 ...
 */
class AVRDwyerAirVel extends \HUGnet\devices\inputTable\DriverAVR
    implements \HUGnet\devices\inputTable\DriverInterface
{
    ...
    */
    protected $params = array(
        "longName" => "Dwyer Air Velocity Sensor",
        "shortName" => "DwyerAirVel",
        "unitType" => "Speed",
        "storageUnit" => 'FPM',
        ...
        "extraDefault" => array(4, 20, 0, 3, 249, 1, 5.0),
        "maxDecimals" => 4,
    ...
    */
    protected function getRaw(
        ...
        $Gain = $this->getExtra(5);
        $Vref = $this->getExtra(6);
        $Val = pow(($value / 4004.4), 2);
        $mA = $this->linearBounded($Val, $Pmin, $Pmax, $Amin, $Amax);
