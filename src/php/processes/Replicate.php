...
/** This is our base class */
require_once dirname(__FILE__)."/replicate/Periodic.php";
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class Replicate extends \HUGnet\ui\Daemon
{
    ...
    */
    protected function __construct(&$config)
    {
        ...
        $this->_plugins = \HUGnet\processes\replicate\Periodic::plugins($this);
    }
    /**
    * Creates the object
    *
