 ...
 * @since      0.9.7
 */
class AverageDaily extends \HUGnet\processes\analysis\Device
{
    /** This is the period */
    ...
    */
    public function &execute(&$device)
    {
        ...
        $this->system()->out("DAILY average plugin starting ", 3);
        ...
        $this->system()->out("DAILY average plugin ending ", 3);
        return true;
    }
    /**
