...
* @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
*/
var DeviceConfigSetImageView = Backbone.View.extend({
    tagName: 'div',
    url: null,
...
* @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
*/
var DeviceConfigSetView = Backbone.View.extend({
    template: '#DeviceConfigSetViewTemplate',
    tTemplate: '#DeviceConfigSetViewTitleTemplate',
    tagName: 'div',
    devImage: null,
    events: {
        'click .close': 'close',
    ...
    initialize: function (options)
    {
        ...
        this.datachannels = new HUGnet.DeviceDataChannelsView({
            ...
            template: "#ConfigSetViewDataChannelListTemplate",
            rowTemplate: "#ConfigSetViewDataChannelEntryTemplate"
        });
        ...
        this.controlchannels = new HUGnet.DeviceControlChannelsView({
            ...
            template: "#ConfigSetViewControlChannelListTemplate",
            rowTemplate: "#ConfigSetViewControlChannelEntryTemplate"
        });
        this.model.on(
            'change',
            this.channelRegen,
        ...
        this.devImage = new DeviceConfigSetImageView({
            model: this.model
        });
    },
