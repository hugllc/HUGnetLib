...
* @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
*/
var OutputTablePropertiesView = Backbone.View.extend({
    template: '#OutputTablePropertiesTemplate',
    tTemplate: '#OutputTablePropertiesTitleTemplate',
    tagName: 'div',
    events: {
        'click .SaveOutputTable': 'save',
    },
...
* @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
*/
var OutputTableEntryView = Backbone.View.extend({
    tagName: 'tr',
    template: '#OutputTableEntryTemplate',
    parent: null,
    events: {
    ...
    {
        var view = new OutputTablePropertiesView({ model: this.model });
...
* @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
*/
HUGnet.OutputTablesView = Backbone.View.extend({
    template: "#OutputTableListTemplate",
    ...
    */
    ...
    {
        var view = new OutputTableEntryView({ model: model, parent: this });
