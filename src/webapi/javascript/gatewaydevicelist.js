...
* @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
*/
HUGnet.GatewayDeviceList = Backbone.View.extend({
    tabs: undefined,
    id: "gatewaydevices-tabs",
    readonly: false,
    data: {},
    devices: {},
    filter: {publish: 1},
    ...
    initialize: function (options)
    {
        ...
        this.devices = new HUGnet.GatewayDevListView({
            model: options.model,
    ...
    render: function ()
    {
        ...
        //this.tabs.find('ul #"'+this.id).append('<li><a href="#'+tag+'">Device List</a></li>');
