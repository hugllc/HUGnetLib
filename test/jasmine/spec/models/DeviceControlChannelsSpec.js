describe("src/webapi/javascript/models/HUGnet.DeviceControlChannels", function() {

    describe("When it is initialized", function() {
        var controlchans;

        beforeEach(function() {
            controlchans = new HUGnet.DeviceControlChannels();
        });
        afterEach(function() {
        });

        it("it should be empty", function() {
            expect(controlchans.length).toEqual(0);
        });
    ...
    describe("When adding and deleting records", function() {
        ...
        it("it should keep them in order by channel", function() {
            ...
            expect(controlchans.pluck("channel")).toEqual([1, 2, 3, 4, 5]);
        });
        it("it should not add the same record more than once", function() {
            ...
            expect(controlchans.pluck("channel")).toEqual([1, 2]);
        });
