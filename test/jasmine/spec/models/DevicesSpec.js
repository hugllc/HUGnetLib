describe("src/webapi/javascript/models/HUGnet.Devices", function() {

    describe("When it is initialized", function() {
        var devices;

        beforeEach(function() {
            devices = new HUGnet.Devices();
        });
        afterEach(function() {
        });
    ...
    describe("When adding and deleting records", function() {
        ...
        it("it should keep them in order by id", function() {
            ...
            expect(devices.pluck("id")).toEqual([1, 2, 3, 4, 5]);
        });
        it("it should not add the same record more than once", function() {
            ...
            expect(devices.pluck("DeviceID")).toEqual([1, 2]);
        });
