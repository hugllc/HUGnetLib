describe("src/webapi/javascript/models/HUGnet.Datacollectors", function() {

    describe("When it is initialized", function() {
        var datacollectors;

        beforeEach(function() {
            datacollectors = new HUGnet.Datacollectors();
        });
        afterEach(function() {
        });

        it("it should be empty", function() {
            expect(datacollectors.length).toEqual(0);
        });
    ...
    describe("When adding and deleting records", function() {
        ...
        it("it should keep them in order by id", function() {
            ...
            expect(datacollectors.pluck("id")).toEqual([1, 2, 3, 4, 5]);
        });
        it("it should not add the same record more than once", function() {
            ...
            expect(datacollectors.pluck("DeviceID")).toEqual([1, 2]);
        });
