...
require_once CODE_BASE.'sensors/DriverVirtual.php';
/** This is a required class */
...
class DriverVirtualTest extends drivers\DriverTestBase
{
    ...
    */
    ...
    {
        $this->o = &DriverVirtualTestClass::factory();
    }
    ...
    */
    ...
    {
        $this->assertSame($expect, DriverVirtualTestClass::getParam($name, 1));
    }
    /**
    * test the set routine when an extra class exists
    *
    ...
    */
    ...
    {
        $this->assertSame(
            $expect, DriverVirtual::getDriver($sid, $type, $FWVersion)
        );
    }
    /**
    ...
    */
    public function testDecode($mocks, $string, $expect)
    {
        ...
        $obj = DriverVirtualTestClass::factory();
