...
require_once CODE_BASE.'devices/datachan/drivers/Direction.php';
...
class DirectionTest extends DriverTestBase
{
    ...
    */
    ...
    {
        parent::setUp();
        $this->o = \HUGnet\devices\datachan\Driver::factory("Direction", "&#176;");
    }
    ...
    */
    ...
    {
        return array(
            array("&#176;", "&#176;", \HUGnet\devices\datachan\Driver::TYPE_RAW),
        );
    }
    /**
    * data provider for testGetTypes
