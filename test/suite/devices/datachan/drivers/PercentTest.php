...
require_once CODE_BASE.'devices/datachan/drivers/Percent.php';
...
class PercentTest extends DriverTestBase
{
    ...
    */
    ...
    {
        parent::setUp();
        $this->o = \HUGnet\devices\datachan\Driver::factory("Percent", "decimal");
    }
    ...
    */
    public static function dataConvert()
    {
        return array(
            array(
                12.312, "decimal", "%", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, .12312
            ),
            array(
                .12312, "%", "decimal", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 12.312
            ),
            array(
                12.312, "decimal", "%", \HUGnet\devices\datachan\Driver::TYPE_DIFF,
                true, .12312
            ),
            array(
                .12312, "%", "decimal", \HUGnet\devices\datachan\Driver::TYPE_DIFF,
                true, 12.312
            ),
            array(
