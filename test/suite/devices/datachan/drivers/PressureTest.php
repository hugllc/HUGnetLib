...
require_once CODE_BASE.'devices/datachan/drivers/Pressure.php';
...
class PressureTest extends DriverTestBase
{
    ...
    */
    ...
    {
        parent::setUp();
        $this->o = \HUGnet\devices\datachan\Driver::factory("Pressure", "Pa");
    }
    ...
    */
    public static function dataConvert()
    {
        return array(
            array(
                100, "Pa", "Torr", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 13332.2
            ),
            array(
                1.6258, "Pa", "atm", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 164732.5592
            ),
            array(
                92.351, "atm", "psi", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 6.284116146
            ),
            array(
                1.351, "atm", "at", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 1.30755184
            ),
            array(
