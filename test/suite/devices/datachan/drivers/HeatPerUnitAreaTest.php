...
require_once CODE_BASE.'devices/datachan/drivers/HeatPerUnitArea.php';
...
class HeatPerUnitAreaTest extends DriverTestBase
{
    ...
    */
    ...
    {
        parent::setUp();
        $this->o = \HUGnet\devices\datachan\Driver::factory("HeatPerUnitArea", "W/m^2");
    }
    ...
    */
    public static function dataConvert()
    {
        return array(
            array(
                12.312, "Btu/hr ft^2", "W/m^2", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 3.902904
            ),
            array(
                3.902904, "W/m^2", "Btu/hr ft^2", \HUGnet\devices\datachan\Driver::TYPE_RAW,
                true, 12.309759216
            ),
            array(
                10,
