...
require_once CODE_BASE.'devices/datachan/drivers/BatStatus.php';
...
class BatStatusTest extends DriverTestBase
{
    ...
    */
    ...
    {
        parent::setUp();
        $this->o = \HUGnet\devices\datachan\Driver::factory("BatStatus", "BatStatus");
    }
    ...
    public static function dataConvert()
    {
        return array(
            ...
            array(
                ...
                true, 'Error - Error: Hardware Overcurrent'
            ),
        );
    }
