...
require_once CODE_BASE.'devices/inputTable/tables/AVRAnalogTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class AVRAnalogTableTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testParamValid($name, $param)
    {
        if (is_array($param["valid"])) {
            ...
            $this->assertTrue(
                ...
                $param["valid"]." is not a method of class AVRAnalogTable"
            );
        } else {
            $this->fail(
