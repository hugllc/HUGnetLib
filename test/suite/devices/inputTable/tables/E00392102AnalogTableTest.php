...
require_once CODE_BASE.'devices/inputTable/tables/E00392102AnalogTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E00392102AnalogTableTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    */
    public function testRegister($mock, $preload, $reg, $set, $expect)
    {
        ...
        $obj = E00392102AnalogTable::factory($sensor, $preload);
    ...
    public function testParamValid($name, $param)
    {
        if (is_array($param["valid"])) {
            ...
            $this->assertTrue(
                ...
                $param["valid"]." is not a method of class E00392102AnalogTable"
            );
        } else {
            $this->fail(
