...
require_once CODE_BASE.'devices/inputTable/tables/E003912AnalogTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E003912AnalogTableTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    */
    public function testRegister($mock, $preload, $reg, $set, $expect)
    {
        ...
        $obj = E003912AnalogTable::factory($sensor, $preload);
    ...
    public function testParamValid($name, $param)
    {
        if (is_array($param["valid"])) {
            ...
            $this->assertTrue(
                ...
                $param["valid"]." is not a method of class E003912AnalogTable"
            );
        } else {
            $this->fail(
    ...
    */
    public function testUses(
        ...
        $obj = E003912AnalogTable::factory($sensor, $config);
        $ret = $obj->uses();
