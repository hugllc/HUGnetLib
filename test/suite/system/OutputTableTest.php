...
require_once CODE_BASE.'system/OutputTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class OutputTableTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    */
    public function testCreate($config, $data, $class, $table)
    {
        ...
        $table->resetMock();
        $obj = OutputTable::factory($config, $data, $class, $dev);
        // Make sure we have the right object
        $this->assertInstanceOf(
            "HUGnet\\OutputTable", $obj, "Class wrong"
        );
    }
    /**
    * Data provider for testCreate
