...
require_once CODE_BASE.'system/PowerTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class PowerTableTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    */
    public function testCreate($config, $data, $class, $table)
    {
        ...
        $table->resetMock();
        $obj = PowerTable::factory($config, $data, $class, $dev);
        // Make sure we have the right object
        $this->assertInstanceOf(
            "HUGnet\\PowerTable", $obj, "Class wrong"
        );
    }
    /**
    * Data provider for testCreate
    ...
    */
    public function test2Array(
        ...
        $obj = PowerTable::factory($sys, null, $class, $dev);
        $json = $obj->toArray();
