...
require_once CODE_BASE.'system/ProcessTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class ProcessTableTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    */
    public function testCreate($config, $data, $class, $table)
    {
        ...
        $table->resetMock();
        $obj = ProcessTable::factory($config, $data, $class, $dev);
        // Make sure we have the right object
        $this->assertInstanceOf(
            "HUGnet\\ProcessTable", $obj, "Class wrong"
        );
    }
    /**
    * Data provider for testCreate
    ...
    */
    public function test2Array(
        ...
        $obj = ProcessTable::factory($sys, null, $class, $dev);
        $json = $obj->toArray();
