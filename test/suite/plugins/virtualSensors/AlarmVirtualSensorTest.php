...
/** Get our classes */
require_once CODE_BASE.'plugins/virtualSensors/AlarmVirtualSensor.php';
 ...
 */
class AlarmVirtualSensorTest extends VirtualSensorPluginTestBase
{
    ...
    */
    ...
    {
        $o = new AlarmVirtualSensor($preload, $this->d);
