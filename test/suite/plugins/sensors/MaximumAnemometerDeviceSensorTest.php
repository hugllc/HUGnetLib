...
/** Get our classes */
require_once CODE_BASE.'plugins/sensors/MaximumAnemometerDeviceSensor.php';
 ...
 */
class MaximumAnemometerDeviceSensorTest extends DeviceSensorPluginTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new MaximumAnemometerDeviceSensor(
            array(
            ),
            $this->d
        );
    ...
    */
    ...
    {
        return array(
            array("MaximumAnemometerDeviceSensor"),
        );
    }
    /**
    ...
    {
        return array(
            array(array(), 500, 300, 2.7275),
            array(array(), 500, 0, null),
            array(array(), 0, 0, null),
            array(array(), -1, 300, 0.0),
            array(array(), 0.000001, 100000, 0.0),
