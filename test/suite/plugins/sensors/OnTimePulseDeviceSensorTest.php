...
/** Get our classes */
require_once CODE_BASE.'plugins/sensors/OnTimePulseDeviceSensor.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class OnTimePulseDeviceSensorTest extends DeviceSensorPluginTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new OnTimePulseDeviceSensor(
            array(
            ),
            $this->d
        );
    ...
    */
    public static function dataSet()
    {
        return array(
            ...
            array("type", "SomethingElse", "ontime"),
            array("type", "j", "ontime"),
        );
    }
    /**
    ...
    */
    public function testGetReading($preload, $A, $deltaT, $expect)
    {
        ...
        $o = new OnTimePulseDeviceSensor($preload, $this->d);
