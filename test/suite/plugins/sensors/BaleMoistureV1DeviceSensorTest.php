...
/** Get our classes */
require_once CODE_BASE.'plugins/sensors/BaleMoistureV1DeviceSensor.php';
 ...
 */
class BaleMoistureV1DeviceSensorTest extends DeviceSensorPluginTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new BaleMoistureV1DeviceSensor(
            array(
            ),
            $this->d
        );
    ...
    */
    ...
    {
        return array(
            array("BaleMoistureV1DeviceSensor"),
        );
    }
    /**
    ...
    */
    public function testGetReading($preload, $A, $deltaT, $expect)
    {
        ...
        $o = new BaleMoistureV1DeviceSensor($preload, $this->d);
