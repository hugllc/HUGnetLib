...
/** This is a required class */
require_once CODE_BASE.'db/DeviceTable.php';
/** This is a required class */
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "DeviceTableStub", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    protected function getDataSet()
    {
        return $this->createXMLDataSet(
            TEST_CONFIG_BASE.'files/DeviceTableTableTest.xml'
        );
    }
    /**
    ...
    */
    public static function dataColumns()
    {
        ...
        $obj = \HUGnet\db\Table::factory(
            $system, $data, "DeviceTableStub", $connect
        );
