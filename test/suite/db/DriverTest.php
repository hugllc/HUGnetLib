...
class DriverTest extends \PHPUnit_Extensions_Database_TestCase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new HUGnetDBDriverTestStub(
            $this->system, $this->table, $this->connect
        );
    }
    ...
    */
    ...
    {
        $obj = new HUGnetDBDriverTestStub($empty, $this->table);
    }
    /**
    * Tests for exceptions
    *
    ...
    */
    ...
    {
        $obj = new HUGnetDBDriverTestStub($this->system, $empty);
    }
    /**
    * Tests for exceptions
    *
    ...
    */
    public function testConstructVerbose($verbose, $expect)
    {
        ...
        $this->system->resetMock($this->config);
        $obj = new HUGnetDBDriverTestStub($this->system, $this->table);
 ...
 * @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class HUGnetDBDriverTestStub extends Driver
{
