...
/** This is a required class */
require_once CODE_BASE.'db/tables/history/E00392401History.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E00392401HistoryTest extends HistoryTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "E00392401History", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    ...
    {
        $this->assertSame("e00392401_history", $this->o->sqlTable);
    }
    /**
    * Generic function for testing sensor routines
    *
    ...
    */
    ...
    {
        $this->assertSame(true, $this->o->getPeriod(1));
    }
    /**
    * Generic function for testing sensor routines
    *
    ...
    * @return null
    */
    public function testNextInto()
    {
        $this->assertSame(false, $this->o->nextInto());
    }
