...
/** This is a required class */
require_once CODE_BASE.'db/tables/history/E10460300History.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E10460300HistoryTest extends HistoryTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "E10460300History", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    ...
    {
        $this->assertSame("e10460300_history", $this->o->sqlTable);
    }
    /**
    * Generic function for testing sensor routines
    *
