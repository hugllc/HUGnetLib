...
/** This is a required class */
require_once CODE_BASE.'db/tables/history/E00394000History.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E00394000HistoryTest extends HistoryTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "E00394000History", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    ...
    {
        $this->assertSame("e00394000_history", $this->o->sqlTable);
    }
    /**
    * Generic function for testing sensor routines
    *
