...
/** This is a required class */
require_once CODE_BASE.'db/tables/DevicePowers.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class DevicePowersTest extends TableTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "DevicePowers", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    protected function getDataSet()
    {
        return $this->createXMLDataSet(
            TEST_CONFIG_BASE.'files/DevicePowersTableTest.xml'
        );
    }
    /**
    ...
    */
    public static function dataColumns()
    {
        ...
        $obj = \HUGnet\db\Table::factory(
            $system, $data, "DevicePowers", $connect
        );
