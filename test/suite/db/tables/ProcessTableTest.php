...
/** This is a required class */
require_once CODE_BASE.'db/tables/ProcessTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class ProcessTableTest extends TableTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "ProcessTable", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    protected function getDataSet()
    {
        return $this->createXMLDataSet(
            TEST_CONFIG_BASE.'files/ProcessTableTableTest.xml'
        );
    }
    /**
    ...
    */
    public static function dataColumns()
    {
        ...
        $obj = \HUGnet\db\Table::factory(
            $system, $data, "ProcessTable", $connect
        );
