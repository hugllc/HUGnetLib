...
/** This is a required class */
require_once CODE_BASE.'db/tables/average/E10460400Average.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E10460400AverageTest extends FastAverageTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "E10460400Average", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    ...
    {
        $this->assertSame("e10460400_average", $this->o->sqlTable);
    }
    /**
    * Generic function for testing sensor routines
    *
