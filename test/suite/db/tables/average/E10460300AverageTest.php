...
/** This is a required class */
require_once CODE_BASE.'db/tables/average/E10460300Average.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E10460300AverageTest extends FastAverageTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "E10460300Average", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    ...
    {
        $this->assertSame("e10460300_average", $this->o->sqlTable);
    }
    /**
    * Generic function for testing sensor routines
    *
    ...
    */
    ...
    {
        $this->assertSame(15, $this->o->datacols);
    }
