...
/** This is a required class */
require_once CODE_BASE.'db/tables/average/E00394000Average.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class E00394000AverageTest extends FastAverageTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "E00394000Average", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    ...
    {
        $this->assertSame("e00394000_average", $this->o->sqlTable);
    }
    /**
    * Generic function for testing sensor routines
    *
