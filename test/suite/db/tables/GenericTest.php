...
/** This is a required class */
require_once CODE_BASE.'db/tables/Generic.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class GenericTableTest extends TableTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "Generic", $this->connect, "myTable"
        );
        $this->o->create();
        parent::Setup();
    }
    ...
    */
    public static function dataColumns()
    {
        ...
        $obj = \HUGnet\db\Table::factory(
            $system, $data, "Generic", $connect, "myTable"
        );
        ...
        return array(
            array(
                \HUGnet\db\Table::factory(
                    $system, "Generic", $data, $connect, "myTable"
                )
            ),
        );
    }
    ...
    */
    ...
    {
        $obj = \HUGnet\db\Table::factory(
            $this->system, $data, "Generic", $this->connect
        );
