...
/** This is a required class */
require_once CODE_BASE.'db/tables/PowerTable.php';
/** This is a required class */
 ...
 * @link       http://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class PowerTableTest extends TableTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = \HUGnet\db\Table::factory(
            $this->system, $data, "PowerTable", $this->connect
        );
        parent::Setup();
    }
    ...
    */
    protected function getDataSet()
    {
        return $this->createXMLDataSet(
            TEST_CONFIG_BASE.'files/PowerTableTableTest.xml'
        );
    }
    /**
    ...
    */
    public static function dataColumns()
    {
        ...
        $obj = \HUGnet\db\Table::factory(
            $system, $data, "PowerTable", $connect
        );
            ...
            array(
                array(
                    ...
                    "params" => '{"driver0":4,"driver1":255,"priority":1'
                        .',"power":0,"ADC0EN":0,"ADC0DIAG":0,"HIGHEXTREF0":0'
