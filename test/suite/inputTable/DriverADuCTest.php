...
require_once CODE_BASE.'inputTable/DriverADuC.php';
/** This is a required class */
...
class DriverADuCTest extends drivers\DriverTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = &\HUGnet\inputTable\DriverADuC::factory(
    ...
    */
    public function testGetTwosCompliment($value, $bits, $entry, $expect)
    {
        $sensor = new \HUGnet\DummyBase("Sensor");
        $sensor->resetMock(array());
        $ent = \HUGnet\inputTable\ADuCInputTable::factory($sensor, $entry);
 ...
 * @since      0.9.7
 */
class DriverADuCTestClass extends \HUGnet\inputTable\DriverADuC
{
    /**
 ...
 * @since      0.9.7
 */
class DriverADuCTestClassDiff extends \HUGnet\inputTable\DriverADuC
{
    /**
    * This is where the data for the driver is stored.  This array must be
    * put into all derivative classes, even if it is empty.
