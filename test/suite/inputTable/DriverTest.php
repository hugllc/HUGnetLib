...
class DriverTest extends drivers\DriverTestBase
{
    ...
    */
    public static function dataFactory2()
    {
        return array(
            array(
                "asdf",
                "HUGnet\inputTable\drivers\SDEFAULT",
            ),
            array(
                "SDEFAULT",
                "HUGnet\inputTable\drivers\SDEFAULT",
    ...
    */
    ...
    {
        $file = CODE_BASE."inputTable/drivers/$class.php";
        $this->assertFileExists(
            $file, "File for $sid:$type and class $class not found"
        );
        include_once CODE_BASE."inputTable/drivers/$class.php";
        $this->assertTrue(
            class_exists("\\HUGnet\\inputTable\\drivers\\".$class),
 ...
 * @since      0.9.7
 */
class DriverTestClass extends \HUGnet\inputTable\Driver
{
    /**
 ...
 * @since      0.9.7
 */
class DriverTestClassDiff extends \HUGnet\inputTable\Driver
{
    /**
    * This is where the data for the driver is stored.  This array must be
    * put into all derivative classes, even if it is empty.
