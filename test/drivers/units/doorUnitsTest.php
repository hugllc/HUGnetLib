...
require_once dirname(__FILE__).'/../../../drivers/units/doorUnits.php';
...
class doorUnitsTest extends UnitTestBase
{
    ...
    public static function main() 
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("doorUnitsTest");
    ...
    {
        return self::getDataUnitArray("doorUnits");
    }
    /**
    ...
    {
        return self::getDataUnitArrayConvertFunct("doorUnits");
    }
    /**
