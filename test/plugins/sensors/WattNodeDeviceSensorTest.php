...
require_once dirname(__FILE__)
    .'/../../../plugins/sensors/WattNodeDeviceSensor.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class WattNodeDeviceSensorTest extends DeviceSensorPluginTestBase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new WattNodeDeviceSensor(
            array(
            ),
            $this->d
        );
    ...
    */
    ...
    {
        return array(
            array(array(), 500, 300, 2.5),
            array(array("extra" => array(1)), 1000, 300, 1),
            array(array(), -500, 300, null),
