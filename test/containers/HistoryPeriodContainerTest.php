...
require_once dirname(__FILE__).'/../../containers/HistoryPeriodContainer.php';
...
/**
 * Test class for HistoryPeriodContainer
 *
 * @category   Containers
 * @package    HUGnetLibTest
 * @subpackage Containers
 ...
 * @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class HistoryPeriodContainerTest extends PHPUnit_Extensions_Database_TestCase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->pdo->query("DROP TABLE IF EXISTS `eDEFAULT_history`");
        $this->hist = new EDEFAULTHistoryTable();
        $this->device = new DeviceContainer();
        $this->o = new HistoryPeriodContainer($data, $this->device);
    ...
    */
    protected function getDataSet()
    {
        return $this->createXMLDataSet(
            dirname(__FILE__).'/../files/EDEFAULT_HistoryTable.xml'
        );
    }
    /**
            ...
            array(
                ...
                array(
                    ...
                    "records" => array(
                        ...
                        new HistoryPeriodContainer($data, $device),
                    ),
                ),
                "DummyTableContainer",
                3,
