 ...
 * @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class DeviceSensorContainerTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    protected function setUp()
    {
        ...
        $this->o = new DeviceSensorContainer($data, $this->d);
    }
    ...
    */
    ...
    {
        $o = new DeviceSensorContainer($data, $this->d);
    ...
    */
    public function testFactory($preload, $expect, $class)
    {
        $o = &DeviceSensorContainer::factory($data, $this->d);
        $this->assertSame($class, get_class($o), "Wrong Class");
        $this->assertAttributeSame($expect, "data", $o, "Wrong data in class");
    }
