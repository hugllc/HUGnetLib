 ...
 *
 */
// Call FunctionsTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'FunctionsTest::main');
}
/** Test framework */
...
class FunctionsTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('FunctionsTest');
...
// Call FunctionsTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'FunctionsTest::main') {
    FunctionsTest::main();
}
?>
