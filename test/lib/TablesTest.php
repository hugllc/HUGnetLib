 ...
 *
 */
// Call TablesTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'TablesTest::main');
}
/** Test framework */
require_once 'PHPUnit/Framework.php';

require_once dirname(__FILE__).'/../../lib/tables.inc.php';
...
class TablesTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('TablesTest');
...
// Call TablesTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'TablesTest::main') {
    TablesTest::main();
}
?>
