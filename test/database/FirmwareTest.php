...
class FirmwareTest extends databaseTest
{
    ...
    public static function dataInterpSREC()
    {
        return array(
            array(
                "S1230000FFFFFFFFFFFFFFFFFFFF0039201343000008FFFFFF5001020202021010"
                    ."02026F46
...
S9030000FC",
                ...
                array(
                    "FFFFFFFFFFFFFFFFFFFF0039201343000008FFFFFF"
                        ...
                        ."00000020270010270000002027001027000000FFFFFFFFFFFFFFFF"
...
S9030000FC",
                ...
                "FF",
                "FFFFFFFFFFFFFFFFFFFF0039201343000008FFFFFF"
                    ."500102020202101002026F6F6F6F6F70707001000000000000000200000"
                    ."00000000010270010270000001027001027000000102700102700000010"
                    ."27001027000000102700102700000010270010270000002027001027000"
                    ."00020270010270000002027001027000000202700102700000020270010"
                    ."27000000202700102700000020270010270000002027001027000000202"
                    ."7001027000000",
           ),
            array(
                "S1230000FFFFFFFFFFFFFFFFFFFF0039201343000008FFFFFF5001020202021010"
...
S9030000FC",
                ...
                array(
                    0 => "FFFFFFFFFFFFFFFFFFFF0039201343000008FFFFFF"
                        ."500102020202101002026F6F6F6F6F7070700100000"
                        ."0000000000200000000000000102700102700000010",
                    1 => "2700102700000010270010270000001027001027000000"
                        ."10270010270000001027001027000000202700102700000"
                        ."02027001027000000202700102700000020",
                    2 => "27001027000000202700102700000020270010270000002027"
                        ."00102700000020270010270000002027001027000000"
     ...
     */
    public function testInterpSREC(
        $srec,
        $MemBufferSize,
        $PageSize,
        $MemBufferEmpty,
     ...
     * @param string $Status    This is the status of the firmware
     * @param string $Active    This is if the firmware is active or not
     * @param array  $expect    The output to expect
     *
     * @return array The array of firmware information
     *
