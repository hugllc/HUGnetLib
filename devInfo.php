...
class DevInfo
{
    ...
    *
    * Note: This function returns the LOWEST possible serial number.  One
    * deviceID could be used for mulitple serial numbers as DeviceID is 3
    * bytes and serial number is 5 bytes.
    *
    ...
    * @return string Hexified version (asciihex)
    ...
    public static function hexifyVersion($version)
    {
        ...
        $str = "";
        for ($i = 0; $i < 3; $i++) {
            $str .= self::setStringSize($ver[$i], 2);
        }
        return $str;
    }
