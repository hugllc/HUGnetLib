 ...
 * @category   Libraries
 * @package    HUGnetLib
 * @subpackage PluginsOutputFilterss
 ...
 * @category   Libraries
 * @package    HUGnetLib
 * @subpackage PluginsOutputFilters
 * @author     Scott Price <prices@hugllc.com>
 * @copyright  2007-2011 Hunt Utilities Group, LLC
 * @copyright  2009 Scott Price
 * @license    http://opensource.org/licenses/gpl-license.php GNU Public License
 * @link       https://dev.hugllc.com/index.php/Project:HUGnetLib
 */
class MovingAverageOutputFilterPlugin extends OutputFilterBase
{
    /** @var This is how many samples to iterate over.  This MUST be odd */
    const SAMPLES = 5;
    /** @var This is to register the class */
    public static $registerPlugin = array(
        "Name" => "5 Sample Moving Average",
        "Type" => "outputFilter",
        "Class" => "MovingAverageOutputFilterPlugin",
        "Flags" => array("movingaverage5"),
    );
    ...
    */
    public function execute($field)
    {
        ...
        foreach (array_keys($this->samples) as $k) {
            $this->data[$k][$field] = $this->_getAverage($k);
        }
        return true;
    }
    ...
    * @return null
    */
    private function _getAverage($index)
    {
        ...
        if (($index < $half)
            ...
            $ret = array_sum($samples) / count($samples);
        }
        return $ret;
    }
